    ...
    public class TurnoController : ControllerBase
    {
        ...
        public async Task<ActionResult> Edit(long? id, int? volver)
        {
            ...
            return View(new TurnoABMViewModel()
            {
                ...
                HorarioEntrada = turno.HorarioEntrada.ToShortDateString() + turno.HorarioEntrada.ToShortTimeString(),
                HorarioSalida = turno.HorarioSalida.ToShortDateString() + turno.HorarioSalida.ToShortTimeString(),
                Motivo = turno.Motivo,
                Numero = turno.Numero,
